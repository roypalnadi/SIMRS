    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <h3 class="d-inline">Create Data Pasien</h3>
                </div>
                <div class="card-body">
                    <form method="post" action={{ route('pasien.store') }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select id="kategori" id="role" class="form-control" name="kategori">
                                    <option @if(old('kategori') == 'Baru') selected @endif value="Baru">Baru</option>
                                    <option @if(old('kategori') == 'Lama') selected @endif value="Lama">Lama</option>
                                </select>
                            </div>
                        </div>
