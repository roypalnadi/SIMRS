    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <h3 class="d-inline">Edit Data Pasien</h3>
                </div>
                <div class="card-body">
                    <form method="post" action={{ route('pasien.update', $id) }}>
                        @csrf
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="noHP" class="form-control @error('noHP') is-invalid @enderror" placeholder="Put Number Here" value={{ $data->no_hp }}>
                                @error('alamat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div id="kateggori" class="form-group row">
                            <label class="col-md-2 col-form-label">kategori</label>
                            <div class="col-md-10">
                                <select class="form-control" name="kategori">
                                    <option @if($data->kategori_pasien == 'Lama') selected @endif value='Lama'>Lama</option>
                                    <option @if($data->kategori_pasien == 'Baru') selected @endif value='Baru'>Baru</option>
                                </select>
                            </div>
                        </div>
